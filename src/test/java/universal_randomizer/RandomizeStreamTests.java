...
//		
//		RandomizeStream<Integer> rss = RandomizeStream.create(list);
...
//
//		rss = RandomizeStream.create(list.stream());
//		assertIterableEquals(list, rss.toList());
//		rs = RandomizeStream.create(list.stream());
//		assertIterableEquals(list, rs.toList());
//		
//		Integer[] array = new Integer[5];
//		rss = RandomizeStream.create(list.toArray(array));
//		assertIterableEquals(list, rss.toList());
...
//		assertNull(RandomizeStream.create(nullList));
//		
//		Stream<Integer> nullStream = null;
//		assertNull(RandomizeStream.create(nullStream));
//		
//		SimpleObject[] nullArray = null;
//		assertNull(RandomizeStream.create(nullArray));
//
//		List<Integer> list = Arrays.asList(1,2,3,4,5);
//		RandomizeStream<Integer> rss1 = RandomizeStream.create(list);
//		rss1.setStream(null);
//		assertIterableEquals(list, rss1.toList());
//		
//		List<Integer> list2 = Arrays.asList(3,6,7);
//		rss1.setStream(list2.stream());
//		assertIterableEquals(list2, rss1.toList());
//	}
//	
//	@Test
//	void duplicate() 
